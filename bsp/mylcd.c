...
void lcd_send_command(uint8_t cmd)
{
	...
	GPIO_WriteToOuputPin(LCD_GPIO_PORTA, LCD_GPIO_RS, GPIO_PIN_RESET);
...
#define LCD_GPIO_D7           GPIO_PIN_NO_1   //PC1   ARD.A4
	...
	GPIO_Handle_t lcd_signal_portB,lcd_signal_portA, lcd_signal_portC;

	lcd_signal_portB.pGPIOx = GPIOB;
	lcd_signal_portB.GPIO_PinConf.GPIO_PinAltFunMode = GPIO_MODE_OUT;
	lcd_signal_portB.GPIO_PinConf.GPIO_PinOPType = GPIO_OP_TYPE_PP;
	lcd_signal_portB.GPIO_PinConf.GPIO_PinPuPdControl = GPIO_NO_PUPD;
	lcd_signal_portB.GPIO_PinConf.GPIO_PinSpeed = GPIO_SPEED_FAST;

	lcd_signal_portB.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_RS;    //ardD8
	GPIO_Init(&lcd_signal_portB);

	lcd_signal_portA.pGPIOx = GPIOA;
	lcd_signal_portA.GPIO_PinConf.GPIO_PinAltFunMode = GPIO_MODE_OUT;
	lcd_signal_portA.GPIO_PinConf.GPIO_PinOPType = GPIO_OP_TYPE_PP;
	lcd_signal_portA.GPIO_PinConf.GPIO_PinPuPdControl = GPIO_NO_PUPD;
	lcd_signal_portA.GPIO_PinConf.GPIO_PinSpeed = GPIO_SPEED_FAST;


	lcd_signal_portA.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_RW;
	GPIO_Init(&lcd_signal_portA);

	lcd_signal_portA.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_EN;
	GPIO_Init(&lcd_signal_portA);

	lcd_signal_portC.pGPIOx = GPIOC;
	lcd_signal_portC.GPIO_PinConf.GPIO_PinAltFunMode = GPIO_MODE_OUT;
	lcd_signal_portC.GPIO_PinConf.GPIO_PinOPType = GPIO_OP_TYPE_PP;
	lcd_signal_portC.GPIO_PinConf.GPIO_PinPuPdControl = GPIO_NO_PUPD;
	lcd_signal_portC.GPIO_PinConf.GPIO_PinSpeed = GPIO_SPEED_FAST;





	lcd_signal_portC.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D4;
	GPIO_Init(&lcd_signal_portC);

	lcd_signal_portC.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D5;
	GPIO_Init(&lcd_signal_portC);

	lcd_signal_portC.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D6;
	GPIO_Init(&lcd_signal_portC);

	lcd_signal_portC.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D7;
	GPIO_Init(&lcd_signal_portC);
	...
	GPIO_WriteToOuputPin(GPIOA, LCD_GPIO_EN, GPIO_PIN_SET);
