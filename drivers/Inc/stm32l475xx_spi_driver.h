 ...
 */
typedef struct{
	SPI_RegDef_t *pSPIx;       /*<This hold the base address of SPIx(x = num ) peripheral>*/
...
/*
 * Possible SPI Applications event
 */
 ...
 */
void SPI_ApplicationEventCallback(SPI_Handle_t * pSPIHandle,uint8_t SPI_EventApp);
